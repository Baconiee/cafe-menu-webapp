...
namespace CafeMenuWebApp.Migrations
{
    ...
    [Migration("20250405195054_InitialCreate")]
            ...
            modelBuilder.Entity("CafeMenuWebApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            USERID = 1,
                            HASHPASSWORD = new byte[] { 143, 67, 67, 70, 100, 143, 107, 150, 223, 137, 221, 169, 1, 197, 23, 107, 16, 166, 216, 57, 97, 221, 60, 26, 200, 139, 89, 178, 220, 50, 122, 164 },
                            NAME = "Berkay",
                            SALTPASSWORD = new byte[] { 161, 178, 195, 212, 229, 246, 7, 24, 41, 58, 75, 92, 109, 126, 143, 144 },
                            SURNAME = "Güler",
                            TenantId = 1,
                            USERNAME = "berkayadmin"
                        });
                });
