...
namespace CafeMenuWebApp.Migrations
{
    ...
    [Migration("20250407213424_UpdateAdminHashSalt")]
    partial class UpdateAdminHashSalt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CafeMenuWebApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            USERID = 1,
                            HASHPASSWORD = new byte[] { 172, 21, 157, 52, 75, 198, 65, 249, 76, 79, 62, 51, 95, 127, 83, 95, 204, 57, 197, 199, 108, 20, 134, 186, 110, 11, 203, 17, 171, 170, 103, 144 },
                            NAME = "Admin",
                            SALTPASSWORD = new byte[] { 211, 146, 185, 23, 194, 132, 251, 69, 183, 187, 156, 195, 191, 64, 160, 155 },
                            SURNAME = "User",
                            TenantId = 1,
                            USERNAME = "admin"
                        });
