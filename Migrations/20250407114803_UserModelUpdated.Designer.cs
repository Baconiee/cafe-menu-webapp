...
namespace CafeMenuWebApp.Migrations
{
    ...
    [Migration("20250407114803_UserModelUpdated")]
            ...
            modelBuilder.Entity("CafeMenuWebApp.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            USERID = 1,
                            HASHPASSWORD = new byte[] { 159, 50, 69, 156, 66, 168, 30, 210, 129, 94, 227, 201, 114, 250, 209, 96, 63, 228, 60, 50, 26, 53, 36, 243, 6, 151, 116, 11, 187, 253, 207, 195 },
                            NAME = "Admin",
                            SALTPASSWORD = new byte[] { 3, 57, 15, 241, 229, 111, 101, 205, 86, 109, 152, 226, 136, 158, 172, 113 },
                            SURNAME = "User",
                            USERNAME = "admin"
                        });
                });
